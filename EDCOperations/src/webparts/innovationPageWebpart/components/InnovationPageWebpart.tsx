...
export default class InnovationPageWebpart extends React.Component<IInnovationPageWebpartProps, IInnovationPageWebpartState> {
  ...
  public componentDidMount(): void {
    ...
    jquery.ajax({
      url: `${this.props.siteUrl}/_api/web/lists/getbytitle('${this.props.listName}')/items` +
        `?$top=5000&$select=Title,IdeaStatus,Author/Title,Created,IdeaDescription,MainIdeaCategory,BusinessImpact,YourOrganization,` +
  ...
  public submitform(): void {
    ...
    jquery("#realizedBenefitsID")[0].value = "";
  ...
  public searchBar(authorevt: any): void {
    ...
    if (searchKey !== "") {
      ...
      `IdeaStatus,IdeaID,Author/Title,Created,IdeaDescription,MainIdeaCategory,BusinessImpact,YourOrganization,YourGEO,` +
...
//Edited By Damu
  ...
  private openideaItem(itmEvt: any): any {
    ...
    return this.props.spHttpClient.get(`${this.props.siteUrl}/_api/web/lists/getbytitle('${this.props.listName}')` +
      ...
      `OwnerComments,Fasttrack,presentationDate,implementationDate,BudgetItem,` +
      ...
      `BusinessImpact,YourOrganization,Nextsteps,Reasoning,RealizedBenefits,ActionsCompleted,Manager,Commented&$Expand=Author,AttachmentFiles`,
      SPHttpClient.configurations.v1,
      {
        headers: {
          "Accept": "application/json;odata=nometadata",
      ...
      .then((item: any): void => {
        ...
        var dispRealizedBenefits: any = itemResult.RealizedBenefits;
        ...
        jquery("#realizedBenefitsID")[0].value = dispRealizedBenefits;
  ...
  private editItemData(editevt: any): any {
    ...
    if (logedinuser === currentItemOwner) {
      ...
      jquery("#realizedBenefitsID").removeAttr("disabled");
  ...
  private submitData(): void {
    ...
    var realizedBenefits: any = jquery("#realizedBenefitsID")[0].value;
    ...
    if (yourorganization === "" || yourGeo === "" || ideaTitle === "" || ideaDesc === "" ||
      mainIdeaCategory === "" || businessImpact === "" || TeamsAffected === "" ||
...
if(chb1.length === 1 && chb2.length === 1 && chb3.length === 1 && chb4.length === 1){
  ...
  private ExporttoExcel(editevt: any): any {
    var table: any = "<table class='new_tab_table' cellspacing= '3 ' cellpadding= '3 ' border= '2 '>" +
      ...
      "<th> Innovation Coach assigned </th><th> Next Steps </th><th> Action Taken </th>" +
    ...
    this.props.spHttpClient.get(`${this.props.siteUrl}/_api/web/lists/getbytitle('${this.props.listName}')` +
      ...
      `YourGEO,Vote,View,Id,ViewedUsers,IdeaID,InnovationCoachAssigned,VotedUsers,Panelpresentation,CommentedUsers,` +
      `Loophasbeenclosed,BusinessImpact,YourOrganization,Nextsteps,Reasoning,ActionsCompleted,Commented,Manager&$Expand=Author&$orderby=Id desc`,
      SPHttpClient.configurations.v1,
      {
        headers: {
          "Accept": "application/json;odata=nometadata",
      ...
      .then((response: SPHttpClientResponse): Promise<IListItem> => {
        ...
        newitems.value.forEach(newitem => {
          table = table + "<tr><td>" + newitem.IdeaID + "</td><td>" + newitem.Vote + "</td><td>" + newitem.Author.Title + "</td>" +
            ...
            "<td>" + newitem.InnovationCoachAssigned + "</td>" +
      ...
      <div className={styles.innovationPageWebpart}>
        <div className={styles.instructions}>
          <div className={styles.instructionsRightDiv}>
            <div className={styles.GotAnIdea} onClick={this.submitform}>Have an idea? Click here to share it!</div>
        ...
        <div id="IdeaNewForm" className={styles.modal}>
          <div className={styles.modalcontent}>
            ...
            <div className={styles.UserControls}>
              ...
              <div className={styles.submitform}>
                <div className={styles.ColumnTitle}>Idea Description <span className={styles.mandatory}>*</span> :</div>
                <div className={styles.ColumnTypes}>
                  <textarea id="ideaDescid" placeholder="Please add more details" name="ideaDescription"></textarea > </div></div>
              <div className={styles.submitform}>
                <div className={styles.ColumnTitle}>Business Impact <span className={styles.mandatory}>*</span> :</div>
                <div className={styles.ColumnTypes}>
              ...
              <div className={styles.submitform}>
                <div className={styles.ColumnTitle}>Org(s) benefitted by this idea (Select all that
                    apply) <span className={styles.mandatory}>*</span> :</div>
                <div className={styles.ColumnTypes}>
              ...
              <div className={styles.submitform}>
                <div className={styles.ColumnTitle}>Cost Involved <span className={styles.mandatory}>*</span> :</div>
            ...
            <div className={styles.leadersControls}>
              ...
              <div className={styles.submitform}>
                ...
                <div className={styles.submitform}>
              <div className={styles.ColumnTitle}>Realized Benefits :</div>
                <div className={styles.ColumnTypes}>
                  <textarea id="realizedBenefitsID" placeholder="Please add more details" name="realizedBenefits"></textarea > </div></div>
              <div className={styles.submitform}>
